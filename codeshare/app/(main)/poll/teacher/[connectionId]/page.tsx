...
import { Submission, Poll, WebSocketRecieve } from "@/lib/dtypes";
  ...
  const handleAddProblem = () => {
    ...
    setPoll((prev) => {
      return {
        ...
        choices: [...prev.choices, currentProblem],
      }
    });
    setCurrentProblem("");
  }
          ...
          <div className="h-full p-4 flex flex-col gap-y-2">
            ...
            >
              <Textarea
                ...
                placeholder="(Markdown supported) Provide poll question here..."
                value={description}
                onChange={(e) => {
            ...
            >
              <Textarea
                ...
                placeholder="Provide poll answer choice here..."
            ...
            <div className="max-h-[60vh] overflow-y-scroll flex flex-col gap-y-3">
            {
              poll.choices.length > 0 ? (
                poll.choices.map((choice, idx) => (
                  <PollcardTeacher content={choice} key={idx} idx={idx} handleDeleteItem={handleDeleteItem} />
                ))
              ) : (
                <div className="bg-muted text-muted-foreground italic rounded-lg p-4 break-words whitespace-break-spaces">
